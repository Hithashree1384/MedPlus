...
//array input to clean array of strings
...
//normalize slots from array of strings to map of date to array of times
function normalizeSlotsToMap(slotStrings = []) {
    ...
    slotStrings.forEach((raw) => {
        ...
        //convert to YYYY-MM-DD and HH:MM AM/PM format
...
export async function createService(req, res) {
    try {
        ...
        return res.status(201).json({ success: true, data: saved, message: "Service created successfully" });
    } catch (error) {
...
export async function getServices(req, res) {
    try {
        ...
        return res.status(200).json({ success: true, data: list, message: "Services fetched successfully" });
    } catch (error) {
...
export async function getServiceById(req, res) {
    try {
        ...
        return res.status(200).json({ success: true, data: service, message: "Service fetched successfully" });
    } catch (error) {
